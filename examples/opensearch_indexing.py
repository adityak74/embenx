...
def run_opensearch_example():
    ...
    by default. You can override this by setting the OPENSEARCH_URL environment variable.
    ...
    try:
        ...
        metadata = [{"id": i, "text": f"Document content for index {i}", "category": "AI"} for i in range(num_vectors)]
