...
def run_synthetic_data_example():
    ...
    metadata = [
        ...
        {"id": 4, "text": "A new species of deep-sea jellyfish was discovered in the Pacific Ocean."},
        {"id": 5, "text": "Stock markets showed volatility following the latest central bank report."}
    ]
    ...
    if not has_api_key:
        ...
        class MockMessage: content = "What are the latest breakthroughs in quantum physics?\nHow is the EV market performing lately?"
